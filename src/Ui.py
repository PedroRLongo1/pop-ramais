...
class Project(QWidget):
    ...
    def init_ui(self):
        ...
        self.input_new_local_pub = QLineEdit(placeholderText="localização na lista publica (apenas preencha se ele deve aparecer na lista publica)")
        self.input_new_local_pub.setObjectName("input_add")
        self.input_new_name_pub = QLineEdit(placeholderText="nome na lista publica (apenas preencha se ele deve aparecer na lista publica)")
